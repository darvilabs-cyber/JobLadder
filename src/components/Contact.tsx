            ...
            <div className="bg-white border border-black/5 rounded-[32px] p-10 lg:p-12">
              {!submitted ? (
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button
                    type="submit"
                    className="w-full bg-gradient-to-r from-[#1e3a8a] to-[#0066CC] text-white px-8 py-5 rounded-full transition-all flex items-center justify-center gap-3 hover:shadow-xl hover:shadow-[#0066CC]/30 hover:scale-[1.02] active:scale-[0.98] relative overflow-hidden group"
