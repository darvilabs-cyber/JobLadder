...
//   return (
//     <div className="pt-16 pb-32 lg:pt-20 lg:pb-40 bg-white">
//       <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
//         <div className="grid lg:grid-cols-2 gap-20 items-start">
//           {/* Image */}
//           <div className="relative group lg:order-1 max-w-[85%] mx-auto lg:pt-[72px]">
...
//             <h2 className="mb-8" style={{ fontSize: 'clamp(40px, 5vw, 55px)', fontWeight: '700', lineHeight: '0.9', letterSpacing: '-0.03em' }}>
//                 <span 
//                   className="block"
//                   style={{ 
...
//                   <div className="relative bg-gray-50 border border-black/5 rounded-2xl p-4 hover:border-[#0066CC]/20 transition-all flex items-center justify-between">
//                     <span className="text-black" style={{ fontWeight: '600', fontSize: '15px' }}>
//                       {level}
//                     </span>
//                     <ArrowUpRight className="text-gray-400 group-hover/card:text-[#0066CC] transition-colors" size={18} />
//                   </div>
//                 </div>
//               ))}
//             </div>
...
//               <h3 className="text-black mb-4" style={{ fontSize: '16px', fontWeight: '600' }}>
//                 What you get
//               </h3>
    ...
    <div className="pt-16 pb-32 lg:pt-20 lg:pb-40 bg-white">
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        <div className="grid lg:grid-cols-2 gap-20 items-start">
          ...
          {/* <div className="relative group lg:order-1 max-w-[85%] mx-auto lg:pt-[100px]">
            <div className="absolute inset-0 bg-gradient-to-br from-[#0066CC]/20 to-blue-500/20 rounded-[32px] blur-2xl opacity-30 group-hover:opacity-50 transition-opacity" />
            <div className="relative overflow-hidden rounded-[32px]">
              <ImageWithFallback
                src="https://images.unsplash.com/photo-1758518730162-09a142505bfd?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxyZWNydWl0bWVudCUyMGludGVydmlld3xlbnwxfHx8fDE3NjQyNDExNDd8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
